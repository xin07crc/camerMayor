        ...
        <div class="slide-area">
          ...
          <div class="descriptions" style="display: none;">
            <div class="desc" >
              ...
              <div class="desc_bottom"><?php print ("<r>Auxiliares de geriatria</r> a domicilio<br><r>Psicologia y terapia ocupacional</r> en casa<br><r>Asistenta</r> por horas e interna ") ?></div>
            </div>
          </div>
          <?php endif; ?>
          ...
          <div class="descriptions" style="display: none;">
            <div class="desc">
              ...
              <div class="desc_bottom"><?php print ("<r>Salvaescaleras</r> para acoplar silla de ruedas</r><br><r>Con asiento</r> incorporado</r><br><r>Para escaleras</r> con giros</r>") ?></div>
            </div>  
          </div>
          <?php endif; ?>
        </div>
...
<font color='#01ace4'>Garantizamos el acceso</font> a pisos, locales, casa, etc a toda España</p>"); ?></div>
      <?php endif; ?>
    </div>
  <?php endif; ?>
